...
Project Number: 01
Description: This is the header file for the Linked List Interface class
Date Due: 02/12/18
----------------------------------------------------------------------------------------*/
...
public:
  ...
  /** Replaces the entry at the given position in this list.
    ...
    @throw  PrecondViolatedExcep if no such entry exists. */
virtual void setEntry(int postition, const ItemType& newEntry) throw(PrecondViolatedExcep) = 0;
}; // end ListInterface
#endif
